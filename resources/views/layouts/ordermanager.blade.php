                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                        ...
                        @auth
                            ...
                            <ul class="navbar-nav mr-auto ">
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="{{ route('orderManagementDashboard') }}">Manage Orders</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="{{ route('productManagementDashboard') }}">Manage Products</a>
                                </li>
