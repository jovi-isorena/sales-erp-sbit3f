        ...
        <div class="col-sm-5 col-md-8">
            ...
            <table class="table" style="width: 100%;">
                ...
                <tbody>
                    ...
                    @foreach ($myorderToShip as $myorderToShips)
      
                    <tr>
    
                        <td>
                            <p> {{ $myorderToShips->OrderID  }} </p>
                        </td>
    
                        <td>
                            <p> {{ $myorderToShips->CustomerID }} </p>
                        </td>
    
                        <td>
                            <p> {{ $myorderToShips->TotalAmount }} </p>
                        </td>
    
                        <td>
                            <p> {{ $myorderToShips->ShippingAddress }} </p>
                        </td>
    
                        <td>
                            <p> {{ $myorderToShips->PaymentMethod }} </p>
                        </td>
    
                        <td>
                            <p> {{ $myorderToShips->OrderStatus }} </p>
                        </td>
...
<h2>{{ $myorderToShips->OrderStatus  }}</h2>
